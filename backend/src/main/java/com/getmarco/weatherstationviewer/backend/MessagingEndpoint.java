 ...
 */
@Api(name = "messaging", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.weatherstationviewer.getmarco.com", ownerName = "backend.weatherstationviewer.getmarco.com", packagePath = ""))
